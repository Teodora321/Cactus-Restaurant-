    ...
    return (
        <MainContainer>
            ...
            <div classname="content">
                ...
                <p>
                When making a registration you will be asked to provide information which is necessary solely for the purpose of using the services and resources of the Website. The collection of this data is carried out in compliance with the applicable privacy measures. 
 
                The use of the Website requires for you to be above the age of 16. By creating a registration, making a purchase or sending an inquiry, you confirm that you are above the age of 16. Users under the age of 16 must have the explicit consent of their parents or legal representatives in order to be granted access to the services of the Website.
  
                The successful registration requires you to fill certain fields marked as mandatory.
                </p>
            </div>
            <div classname="content">
